...
describe('Testa a rota GET /conta/:CodCliente/transacoes', () => {
    ...
    describe('Quando é passado o CodCliente de um cliente existente', () => {
        (0, mocha_1.before)(() => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(app_1.default).get('/conta/1/transacoes');
    ...
    describe('Quando é passado o CodCliente de um cliente que não existe', () => {
        let body;
        (0, mocha_1.before)(() => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(app_1.default).get('/conta/15/transacoes');
            status = response.status;
            body = response.body;
        }));
    ...
    describe('Quando é passado o CodCliente de um cliente que não executou nenhuma transação', () => {
        let body;
        (0, mocha_1.before)(() => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(app_1.default).get('/conta/4/transacoes');
            status = response.status;
            body = response.body;
        }));
        it('A requisição retorna o status 404', () => {
    ...
    describe('Quando é passado um parâmetro que não é um número', () => {
        let body;
        (0, mocha_1.before)(() => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield chai_1.default.request(app_1.default).get('/conta/teste/transacoes');
            status = response.status;
            body = response.body;
        }));
        it('A requisição retorna o status 404', () => {
