...
const checkAsset = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { CodAtivo } = req.body;
    const ativo = yield Ativo.findByPk(CodAtivo, { attributes: ['CodAtivo'] });
    if (!ativo) {
        throw new HTTPErrorMessage_1.default(404, 'Esse ativo não existe');
    }
    return next();
});
exports.default = checkAsset;
